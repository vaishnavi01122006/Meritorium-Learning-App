...
const ProfilePage = () => {
  const [name, setName] = useState('Vaishali Malkar');
  const [email, setEmail] = useState('vaishalimalkar@gmail.com');
  ...
  const handleLogout = () => {
    ...
    router.replace('/(Index)'); // Redirect to InstructorLogin page
  };
